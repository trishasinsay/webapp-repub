...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,200;0,300;0,400;0,500;0,600;0,7001,300&display=swap" rel="stylesheet">
</link>
    ...
    return (
        <div className={styles.container}>
            ...
            <div class={styles.card}>
                <image class={styles.card__image} src="3.png" alt="image"/>
