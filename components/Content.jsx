    ...
    <div className={styles.container}>
        ...
        <div class={styles.card}>
            ...
            <div class={styles.card1}>
                <image class={styles.card__image1} src="2.png"/>
            ...
            <div class={styles.card4}>
                <image class={styles.card__image4} src="5.png"/>
            ...
            <div class={styles.card5}>
                <image class={styles.card__image5} src="6.png"/>
